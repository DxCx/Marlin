...
#define STRING_CONFIG_H_AUTHOR "A2Z" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Winterfell"
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER 3.9    // Y offset: -front +behind [the nozzle]

// HAGAI: IMPORTANT CONSTANT => THIS IS THE DISTANCE FROM SENSOR TO BED
#define Z_PROBE_OFFSET_FROM_EXTRUDER -9.5   // Z offset: -below +above  [the nozzle]
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 86.48}  // default steps per unit for Kossel (GT2, 20 tooth)
